...
def main(results_dir, plot_output_dir, verbose=False):
    """Generate reproducibility plots from experiment result files.

    Args:
        results_dir (str): Directory containing experiment JSON result files.
        plot_output_dir (str): Directory where the output plot PDF will be saved.
        verbose (bool): If True, print informational messages during execution.
    """
    ...
    for expConfig_num in expConfig_nums:
        ...
        for repeat_num in repeat_nums:
            try:
                ...
                if verbose:
                    print(f"Couldn't find the data statistics for expConfig={expConfig_num}, repeat={repeat_num}")
                curr_expConfig = None
            ...
            try:
                ...
                if verbose:
                    print(f"Couldn't find the classification results for expConfig={expConfig_num}, repeat={repeat_num}")
                curr_dataStats = None
...
if __name__ == '__main__':
    ...
    main(results_dir, plot_output_dir, verbose)
